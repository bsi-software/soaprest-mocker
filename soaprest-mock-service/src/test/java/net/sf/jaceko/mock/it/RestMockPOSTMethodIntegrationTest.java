...
public class RestMockPOSTMethodIntegrationTest {
	...
	private static final String REST_MOCK_POST_RECORDED_REQUESTS_HEADERS = "http://localhost:8088/mock/services/REST/dummy-rest/operations/POST/recorded-request-headers";
